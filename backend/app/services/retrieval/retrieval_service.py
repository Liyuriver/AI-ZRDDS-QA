...
def retrieve_candidates(query: str, top_k: int = 10, requested_version: Optional[str] = None) -> list[dict[str, Any]]:
    """Return complete BM25 chunks in the common fusion shape's input format."""
    response = retrieve(query, top_k=top_k, requested_version=requested_version)
